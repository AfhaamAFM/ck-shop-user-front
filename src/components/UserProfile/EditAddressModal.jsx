          ...
          Launch static backdrop modal
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>Edit this Address</Modal.Title>
                </Modal.Header>
                <Modal.Body>
...
value={state}
                ...
                <Modal.Footer>
                    <Button variant="secondary" onClick={editAddressHandleClose}>
                        Close
                    </Button>
                    {loading ? <div className="spinner-border" role="status">
                        <span class="sr-only">Loading...</span>
                    </div>
                        : <Button onClick={editAddressHandler} variant="primary" disabled={flatNOError ||
                            numberError ||
                            pincodeError ||
                            nameError ||
                            streetError ||
